...
namespace Lab08_studnetMS
{
    ...
    {
        // Them TrustServerCertificate=True; và Encrypt=False;
        SqlConnection conn = new SqlConnection("Data Source=KITSU\\SQLEXPRESS;Initial Catalog=StudentDB;Integrated Security=True;Trust Server Certificate=True;Initial Catalog=StudentDB;Integrated Security=True;Trust Server Certificate=True");
        SqlDataAdapter da;
        ...
        private void frmSinhVien_Load(object sender, EventArgs e)
        {
            try
            {
                // --- Buoc 1: lay du lieu khoa do vao combo box---
                ...
                txtmasoSV.DataBindings.Add("Text", bs, "MaSo", true);
                ...
                txtSoDT.DataBindings.Add("Text", bs, "DienThoai", true);
